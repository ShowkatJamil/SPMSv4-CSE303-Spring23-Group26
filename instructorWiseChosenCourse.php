...
<html lang="en">
  ...
  <meta charset="utf-8" />
    ...
    <title>Instructor Wise (Chosen Course) Performance </title>
    <!--Google Font-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Instructor Wise (Chosen Course) Performance</h2>
...
<div class="row3">
<button class="view" onclick="viewInstructorWiseChosenCourse()"> view</button>
</div>
