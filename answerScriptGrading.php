...
<html lang="en">
  ...
  <meta charset="utf-8" />
    ...
    <title>Answer Script Grading</title>
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Answer Script Grading</h2>
...
<!-- php code for analysis starts here -->
  ...
  //loop php part ends here
    ...
    <div id = "id-input-container"> <input type="submit" style="margin-top:20px;margin-left:0px;" name="submitMark" value="Submit" class="id-submit"></div>
