  ...
  <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.0-alpha2/dist/js/bootstrap.bundle.min.js" integrity="sha384-qKXV1j0HvMUeCBQ+QVp7JcfGl760yU08IQ+GpUo5hlbpg51QRiuqHAJz8+BrxE/N" crossorigin="anonymous"></script> 
    ...
    <form>
        ...
        <div class="form-row">
          ...
          <input type="text" id="educational-year" name="year" min="2012" max="2030" required>
        </div>
      
        <div class="form-row">
          <label for="educational-semester">Educational Semester:</label>
          <select id="educational-semester" name="semester" required>
        ...
        <div class="form-row">
          ...
          <input type="text" id="enrolled-course" name="courseID" required>
        </div>
      
        <div class="form-row">
          <label for="enrolled-section">Enrolled Section:</label>
          <input type="text" id="enrolled-section" name="sectionID" required>
        </div>
      
        <div class="form-row">
          <label for="obtained-grade">Obtained Grade:</label>
          <input type="text" id="obtained-grade" name="obtained-grade" required>
        </div>
      
        <div class="button-row-upload">
          <label for="file-upload">Upload File:</label>
          <input type="file" style="height: 30px; width: 100px;" id="file-upload" name="upload">
