...
<html lang="en">
  ...
  <meta charset="utf-8" />
    ...
    <title> View Answer Script</title>
    <!--Google Font-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">View Answer Script</h2>
...
<form method="post">
      <div class="row3">
        <input type="text" class="id-input" placeholder="Exam Name" name="examName"/>


      <select name="courseID" class="select" style= "margin-left: 10%; margin-right: 10%;">
    ...
    <select name="semester" class="select">
     ...
     <input type="submit" name="submit" value="Submit" class="id-submit" style= "margin-left: 13%; margin-right: 13%;">
   ...
   <?php
     ...
     echo "<script>window.location.href ='answerScriptGrading.php'</script>";
