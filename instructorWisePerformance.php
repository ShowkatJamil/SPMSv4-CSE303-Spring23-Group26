            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Instructor Wise Performance</h2>
...
<!-- div row-1 -->
<div class="row1" style="height: 70px;">
  <form method="POST">
   ...
   <select name="year" class="select">
      <option disabled selected>Year</option>
       ...
       <input class="id-submit" type="submit" name="submitInstructorName" value="Submit"/>
       </div>
</div>
...
<div class = "row3">
<button class="view" onclick="viewInstructorWise()"> view</button>
</div>
