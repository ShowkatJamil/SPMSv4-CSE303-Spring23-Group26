...
<html lang="en">
  ...
  <meta charset="utf-8" />
    ...
    <title>View Available Exams</title>
    <!--Google Font-->
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">View Available Exams</h2>
...
<!-- php code for analysis starts here -->
    ...
    <input type="text" class="id-input" placeholder="Student ID" name="studentID"/>
   ...
   <div id = "id-input-container"><input type="submit" style="margin-top:20px;" name="submit" value="Submit" class="id-submit"></div> 
   </form>    
