            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Course-wise Performance</h2>
  ...
  <form method="POST">
   ...
   <select name="year" class="select">
      <option disabled selected>Year</option>
       ...
       <input class="id-submit" type="submit" name="submitCourseCode" value="Submit"/>
       </div>
</div>


<div class="row2">
<input class="id-input" type="text" placeholder="Enter course code" name="course1"/>
<input class="id-input" type="text" placeholder="Enter course code" name="course2"/>
<input class="id-input" type="text" placeholder="Enter course code" name="course3"/>
</form>              
</div>

<div class="row3">                   
<button class="view" onclick="viewCourseWise()"> view </button>
</div>
