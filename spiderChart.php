            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h2 class="mt-4">Spider Chart Analysis</h2>
...
<div id = "id-input-container">
     ...
     <input class="id-submit" type="submit" name="submit" value="Enter"/>
  </div>
    </form>       
        ...
        <!-- div row-2 -->
    <div class ="row3" style = "margin-top: 0px; margin-bottom: 25px;">

    <button class="School-wise" style="margin-right: 5px; margin-left: 0px;" onclick="poView()">view PO analysis</button>
    <button class="School-wise" style="margin-right: 0px; margin-left: 0px;" onclick="coView()" style="width:200px;">View CO analysis</button>
    
    </div> <!-- div row-2 ends here -->

        <div style="display:flex;justify-content:center;margin-top:5px;height:600px;width:100%;"class="row3"> 
        <canvas style="background-color:white;height:600px;width:600px;" id="myChart"></canvas>
